...
dataset = pd.read_csv('C:/Users/AISELab/Desktop/train.csv', encoding='utf-8')
#
# 데이터 형태 확인
print(dataset.info)
#
...
# numpy가 아닌 pandas로 해야 Label Encoding 가능?
dataset = np.loadtxt("C:/Users/AISELab/Desktop/new_train.csv", delimiter=",", skiprows=1, dtype=np.float32)
